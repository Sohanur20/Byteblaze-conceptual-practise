...
const SingleBlogCart = () => {
    ...
    const { title, comments_count, reading_time_minutes, public_reactions_count, published_at } = blogs
            ...
            <div className="max-w-3xl px-6 py-16 mx-auto space-y-12">
                <article className="space-y-8 dark:bg-gray-100 dark:text-gray-900">
                    ...
                    <div className="flex items-center -mx-4 overflow-x-auto overflow-y-hidden  flex-nowrap dark:bg-gray-100 dark:text-gray-800">
                        ...
                        <Link to='/bookmarks'>
                            <div onClick={() => handleClick(blogs)} className='bg-primary p-3 ml-5 rounded-full hover:bg-opacity-30 bg-opacity-20 cursor-pointer hover:scale-105 overflow-hidden text-2xl'>
