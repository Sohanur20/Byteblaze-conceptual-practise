...
import none from '../../assets/404.jpg'

const Author = () => {

    const blogs = useLoaderData()
    const { name ,profile_image , username , github_username , twitter_username, website_url } = blogs.user


    return (
        <div>
           <div className="flex flex-col justify-center  p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800">
	<img src={profile_image || none} alt="" className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
